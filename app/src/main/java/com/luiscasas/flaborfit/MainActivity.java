...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXERCISE_WEIGHTS = "Weight Liftinh";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weightBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                loadDetailActivit(MainActivity.EXERCISE_WEIGHTS);
            }
        });
        ...
        yogaBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                loadDetailActivit(MainActivity.EXERCISE_YOGA);
            }
        });
        ...
        cardioBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                loadDetailActivit(MainActivity.EXERCISE_CARDIO);
            }
        });

    }

    private void loadDetailActivit(String exerciseTitle){
